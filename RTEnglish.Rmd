...
data <- read_csv("clinton-maidan.csv", col_types = col_types)
...
sums2 %>%
  ...
  labs(
    ...
    subtitle = "Term: 'republicanparty', RT Search Term: 'clinton maidan'",
    x = "Date",
    y = "Frequency"
  ...
  ggsave("clinton-maidan/republicanparty.png", width = 10)
```
...
```{r}
wordcloud(words = head$term, freq = head$count, min.freq = 40,

...
data456789 <- bind_rows(data45678, data9)
data45678910 <- bind_rows(data456789, data10)
data4567891011 <- bind_rows(data45678910, data11)
data456789101112 <- bind_rows(data4567891011, data12)
all_soros <- bind_rows(data456789101112, data13)
...
sums2d %>%
  ...
  group_by(ArtDate) %>% 
  summarise(Frequency = sum(investig)) %>%
  ggplot(aes(x = ArtDate, y = Frequency)) +
  geom_point() +
  geom_smooth(method = 'loess') +
  labs(
    title = "Term Frequency Per Article Over Time",
    subtitle = "Term: 'investig', RT Search Term: N/A, 'Soros' Terms",
    x = "Date",
    y = "Frequency",
  ...
  ggsave("all-soros/investig.png", width = 10)
```

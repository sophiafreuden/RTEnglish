...
data <- read_csv("clinton-orange-revolution.csv", col_types = col_types)
...
sums2d %>%
  ...
  labs(
    ...
    subtitle = "Term: 'war', RT Search Term: 'clinton orange revolution'",
    x = "Date",
    y = "Frequency",
  ...
  ggsave("clinton-orange-revolution/war.png", width = 10)
```
...
```{r}
wordcloud(words = head$term, freq = head$count, min.freq = 20,
...
sum2 %>%
  ...
  tab_header(
    ...
    subtitle = "RT Search Term: 'clinton orange revolution'"
    )  %>% 
  # #tab_source_note(
  ...
  gtsave("clinton-orange-revolution/table1.png", zoom = 2.5, expand = 10)
```
...
ggplot(sent3, aes(x = emotion, y = count, fill = emotion)) +
  ...
  ggsave("clinton-orange-revolution/emo1.png", width = 10)
```

...
data <- read_csv("soros-elections.csv", col_types = col_types)
...
sums2d %>%
  ...
  labs(
    ...
    subtitle = "Term: 'democraci', RT Search Term: 'soros elections'",
    x = "Date",
    y = "Frequency",
...
```{r}
wordcloud(words = head$term, freq = head$count, min.freq = 75,
...
sum2 %>%
  ...
  tab_header(
    ...
    subtitle = "RT Search Term: 'soros elections'"
    )  %>% 
  # #tab_source_note(

...
temp <- unique(temp)
# temp2 <- sums2d %>% select(c(ArtDate, browder))
view(temp)
print(data$URL[522]) # 28
print(data$URL[842]) # 25
print(data$URL[113]) # 23
print(data$URL[12]) # 22
print(data$URL[72]) # 22
print(data$URL[661]) # 21
print(data$URL[39]) # 19
print(data$URL[35]) # 18
print(data$URL[466]) # 18
print(data$URL[658]) # 18

print(data$date[522]) # 28
print(data$date[842]) # 25
print(data$date[113]) # 23
print(data$date[12]) # 22
print(data$date[72]) # 22
print(data$date[661]) # 21
print(data$date[39]) # 19
print(data$date[35]) # 18
print(data$date[466]) # 18
print(data$date[658]) # 18
